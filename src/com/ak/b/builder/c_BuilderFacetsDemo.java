...
class Person1 {
	...
	public String toString() {
		return "Person1{" + "streetAddress='" + streetAddress + '\'' + ", postcode='" + postcode + '\'' + ", city='"
...
class c_BuilderFacetsDemo {
	public static void main(String[] args) {
		PersonBuilder1 pb = new PersonBuilder1();
		Person1 person = pb.lives().at("123 London Road").in("London").withPostcode("SW12BC").works().at("Fabrikam")
